					   ...
					   <div class="limit-box">
						  <nav class="main-menu">
							 <ul class="menu-area-main">
								...
								<li class="active"> <a href="signupCustomer.html">Sign Up</a> </li>
		...
		<div class="form-v10-content">
			<form class="form-detail" action="#" method="post" id="myform">
				<div class="form-left">
					...
					<div class="form-row">
						<input type="text" name="mobileNo" class="mobileNo" id="mobileNo" placeholder="Mobile Number"
							required length=10>
					</div>
					<div class="form-group">
				...
				<div class="form-right">
					...
					<div class="form-row">
						<input type="text" name="pincode" class="pincode" id="pincode" placeholder="Pincode" required>
					</div>
