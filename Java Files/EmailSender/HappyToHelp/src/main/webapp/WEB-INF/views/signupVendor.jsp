...
<body class="form-v10" style>
	...
	<div class="page-content">
		<div class="form-v10-content">
			<form class="form-detail" action="vendorAdding" method="post" id="myform" enctype="multipart/form-data">
				<div class="form-left">
				...
				<div class="form-right">
                    ...
                    <div class="form-row">
					<input type="file" id="customFile" name="file" accept="image/png, image/jpeg"/>	
				    </div>
					<!-- <div class="form-row">
